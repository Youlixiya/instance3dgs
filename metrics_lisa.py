...
if __name__ == '__main__':
    ...
    parser.add_argument("--lisa_output_path", type=str, default='output/lisa')
    ...
    for scene in scenes:
        ...
        iou = []
        acc = []
        mask_path = os.path.join(args.lisa_output_path, scene, prompt)
    ...
    with open(f'lisa_metrics.txt', 'w') as f:
        f.write(metrics)
