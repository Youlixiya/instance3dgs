...
CUDA_VISIBLE_DEVICES=5 python test_ovs3d.py --cfg_path scripts/16_ovs3d_test_config.json --scene sofa


#bed
CUDA_VISIBLE_DEVICES=5 python train_gs.py --source_path data/ovs3d/bed --images images_4 --model_path output/ovs3d/bed
...
CUDA_VISIBLE_DEVICES=5 python test_ovs3d.py --cfg_path scripts/16_ovs3d_test_config.json --scene bed
...
CUDA_VISIBLE_DEVICES=3 python test_ovs3d.py --cfg_path scripts/16_ovs3d_test_config.json --scene bench
...
CUDA_VISIBLE_DEVICES=3 python test_ovs3d.py --cfg_path scripts/16_ovs3d_test_config.json --scene room
