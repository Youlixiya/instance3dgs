...
CUDA_VISIBLE_DEVICES=5 python demo/demo_with_text.py --chunk_size 4 --img_path ../data/ovs3d/room/images_4 --amp --temporal_setting semionline --size 480 --output ./example/wood_wall --prompt "wood wall." --DINO_THRESHOLD 0.72
